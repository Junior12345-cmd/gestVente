                            ...
                            <tbody>
                               <?php 
                                    foreach($pointVentes as $pointVente):
                                        if($pointVente->getTypePoint()=="EnDetail"):
                                ?>
                                <tr>
        ...
        <form action="<?= HOST;?>update-pointVente.html" method="POST" id="form_id">
                <div class="modal-body mt-3">
                    <div class="form-group col-sm-5">
                            ...
                            <input type="hidden" class="form-control" id="m_typePoint" name="values[typePoint]" value="EnDetail"> 
                        </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label for="montantVendu">Montant Vendu de Lubrifiant</label>
                            <input type="int" class="form-control" id="m_montantVendu" name="values[montantVendu]" required>                     
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="montantComplement">Montant complémenté en Lubrifiant</label>
                            <input type="int" class="form-control" id="m_montantComplement" name="values[montantComplement]" required>                     
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label for="montantRetire">Montant retiré en Lubrifiant</label>
                            <input type="int" class="form-control" id="m_montantRetire" name="values[montantRetire]" required>                     
                        </div>
                        <div class="form-group col-sm-6">
                            <label for="depenses">Dépenses</label>
                            <input type="int" class="form-control" id="m_depenses" name="values[depenses]" required>                     
                        </div>
                    </div>
                    <div class="row">
                        <!-- <div class="form-group col-sm-6">
